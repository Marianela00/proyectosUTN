Proceso CajaPizzeria
	menu();
	// Arreglar cierre de caja y bienvenida 
FinProceso
...
SubProceso menu()
	...
	Repetir
		...
		tipoOrden();
				Limpiar Pantalla;// menu de pizza el ciclo se repite hasta marca 4 y suma la las variedades de pizza
				Repetir
					Escribir "---------------------------------";
		...
		//escribimos el tiket
		Limpiar Pantalla;
		ticket(nombre,mozo,vuelto,caja,total,totalCierre,pxu1,pxu2,pxu3,pc,pj,pf,aguaMineral,Cerveza,Gaseosa,precioAtotal,precioCEtotal,precioGtotal,precioctotal,preciojtotal,precioftotal);
		Leer terminar;
...
SubProceso tipoOrden()
	...
	FinSegun
FinSubProceso
SubProceso ticket(nombre,mozo,vuelto,caja,total,totalCierre,pxu1,pxu2,pxu3,pc,pj,pf,aguaMineral,Cerveza,Gaseosa,precioAtotal,precioCEtotal,precioGtotal,precioctotal,preciojtotal,precioftotal)
